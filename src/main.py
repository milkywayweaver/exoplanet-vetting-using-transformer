...
''' DEFINE MODEL'''
MODEL = Transformer(EMBED_DIMS,NUM_HEADS,DROPOUT,HIDDEN,DEPTH,NUM_CLASSES,GLOBAL_EMBED_LENGTH=GLOBAL_EMBED_LENGTH,LOCAL_EMBED_LENGTH=LOCAL_EMBED_LENGTH).to(device)
